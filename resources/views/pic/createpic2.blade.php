  ...
  <tr >
      ...
      {{csrf_field()}}
            ...
            <select class="form-control"   name="client">
                   ...
                   <?php 
              foreach($client as $ja) {
               
                echo "<option value='".$ja->id."'";
                   if( $ja->id  == old('client') ) { echo " selected='selected'  ";  } 
                echo ">".$ja->companyname."</option>";
    ...
    <tr >
            <td  style="background: #7EC0EE"  class="col-md-1"><strong><font color="556B2F">Division </font><font style="color:red">*</font></strong></td> 
            <td colspan="3" class="col-md-5" >
       <select class="form-control"    name="division_id">
                <option value="{{ old('division_id')}}" selected="selected"   >
                {{ old('division_id')}} </option>
      </select>
        <input name="divName" id="divNameid" type="hidden"  >  
      </td> 
    </tr>
		<tr >
            <td  style="background: #7EC0EE"  class="col-md-1"><strong><font color="556B2F">
		...
		<tr >
            ...
            <td class="col-md-1" >
			<select class="form-control" value="{{ old('status')}}"  
      style="width: 50%" name="status"  
      id="status" >
