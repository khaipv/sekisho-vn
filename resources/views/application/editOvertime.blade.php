...
@section('content')
      <div class="content container">
                   ...
                   <b style="font-size: 18px">  Edit Applications </b>
                   <!-- approve.editOvertime.blade -->
                </div>
       </div>  
    ...
    <tbody>
      <tr>
            <td style="padding-top: 20px;">
              <input type="date"    id="dateOTID" name="dateOT"   value="{{ $deleteObjOVT->date}}"  onchange="dateOTHand(event);" required
           style="width: 100%;"    >
            </td>
            <td style="padding-top: 20px;">
            ...
            <td style="padding-top: 20px;">
               <input type="Time"  required   id="fromOTID" name="fromOT"
                value="{{ $deleteObjOVT -> start }}" 
           style="width: 100%"   >
            </td>
            <td style="padding-top: 20px;">
               <input type="Time"  required  id="toOTID" name="toOT" value="{{$deleteObjOVT->end}}"
           style="width: 100%"   >
            </td>
            <td>
              <textarea  name="note" class="form-control"  style="resize: none;">{{$deleteObjOVT->note}}</textarea>  
            </td>
      </tr>
    </tbody>
  </table>
...
<table  class="table table-hover table-bordered" >
  ...
  <tr>
            ...
            <td style="padding-top: 20px;">
               ...
               <input type="hidden" id="mannote2" name="mannote2" 
             value= "{{$deleteObjOVT->mannote2}}">
             <input type="hidden" id="status" name="status" 
             value= "{{$deleteObjOVT->status}}">
            </td >
  </tr>
  </tbody>
  </table>
...
<input type="hidden" id="typeID" name="typeID" value="{{ $type}}">
  <table  class="table table-hover table-bordered" >
    ...
    <tbody>
      <tr>
         <td style="padding-top: 20px;">
              <input type="date"    id="dateHOID" name="dateHO"  
              value="{{ $deleteObjOVT->date}}" onchange="dateOTHand(event);" required
           style="width: 100%;"    >
            </td>
            <td style="padding-top: 20px;">
  ...
  @if($deleteObjOVT->datenum == $deleteObjOVT->oriNum)
  <input type="submit" class="btn" value="Update">
  @else 
  <b> Your Compensatory Day was used. Please edit your Compensatory Days first </b>
  @endif
</form>
  </div>
   @endif
...
<table class="table table-hover table-bordered" >
  <tr>
      ...
      <input type="date" class="form-control"     id="dateDOFromID" name="dateDOFrom"  value="{{$deleteDayoff->fromDate}}"   required
           style="width: 85%;"    >
      ...
      <td class="col-md-1" >
        ...
        <input type="date" class="form-control"     id="dateDOToID" name="dateDOTo" 
         value="{{$deleteDayoff->toDate}}"  style="width: 85%;"    > 
