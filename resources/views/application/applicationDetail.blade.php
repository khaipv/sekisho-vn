...
@section('content')
  ...
  <div class="col-sm-2"  > </div> 
    ...
    <label for="lgFormGroupInput" class="col-sm-12 col-form-label col-form-label-sm"  style="text-align: left; font-size: 18px">
...
<div class="col-sm-12"  > 
     <div class="col-sm-5"  > 
        @if($previous<>0)
        <a  href="{{action('ApplicationController@appAprove', [$previous,$previousType,$previousTypeID,$idlist,$typedblist,$next] )}}">
   Previous</a>
        @endif
           </div>
           <div class="col-sm-6"  > 
    ...
    <div class="col-sm-1"  > 
        @if($next<>0)
        <a  href="{{action('ApplicationController@appAprove', [$next,$nextType,$nextTypeID,$idlist,$typedblist,$next] )}}"> Next</a>
          @endif
